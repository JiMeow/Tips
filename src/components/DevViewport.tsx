const DevViewport = () => {
  return (
    <div
      className="3xl:bg-violet-500 fixed bottom-0 left-0 z-50 m-8 flex h-6 w-6 items-center justify-center rounded-full bg-gray-500 p-3 font-mono text-xs 
    ...
    >
      ...
      <div className="3xl:hidden z-50 hidden 2xl:block">2xl</div>
      <div className="3xl:block z-50 hidden">3xl</div>
    </div>
  );
};
